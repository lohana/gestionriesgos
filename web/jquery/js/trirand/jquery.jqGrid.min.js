...
(l+=" "+p+"="+g[p])}return'<tr role="row" id="'+b+'" tabindex="'+k+'" class="'+e+'"'+(""===c?"":' style="'+c+'"')+l+">"},C=function(b,c,e,f,h){var g=new Date,k="local"!==d.p.datatype&&d.p.loadonce||"xmlstring"===d.p.datatype,l=d.p.xmlReader,p="local"===d.p.datatype?"local":"xml";k&&(d.p.data=[],d.p._index={},d.p.localReader.id="_id_");d.p.reccount=0;if(a.isXMLDoc(b)){-1!==d.p.treeANode||d.p.scroll?e=1<e?e:1:(v.call(d,!1,!0),e=1);var n=a(d),m,q,t=0,A,K=!0===d.p.multiselect?1:0,y=0,Z,C=!0===d.p.rownumbers?
1:0,H,I=[],O,z={},F,J,E=[],M=!0===d.p.altRows?d.p.altclass:"",ha;!0===d.p.subGrid&&(y=1,Z=a.jgrid.getMethod("addSubGridCell"));l.repeatitems||(I=w(p));H=!1===d.p.keyName?a.isFunction(l.id)?l.id.call(d,b):l.id:d.p.keyName;p=-1===String(H).indexOf("[")?I.length?function(b,d){return a(H,b).text()||d}:function(b,d){return a(l.cell,b).eq(H).text()||d}:function(a,b){return a.getAttribute(H.replace(/[\[\]]/g,""))||b};d.p.userData={};d.p.page=r(a.jgrid.getXmlData(b,l.page),d.p.page);d.p.lastpage=r(a.jgrid.getXmlData(b,
...
(V=!0===d.p.groupingView.groupCollapse,S=a.jgrid.getMethod("groupingPrepare"));for(;G<R;){F=b[G];J=p(F,N+G);J=d.p.idPrefix+J;m=0===e?0:e+1;ha=1===(m+G)%2?M:"";var ca=E.length;E.push("");C&&E.push(s(0,G,d.p.page,d.p.rowNum));K&&E.push(x(J,C,G,!1));y&&E.push(Z.call(n,K+C,G+e));if(l.repeatitems){O||(O=B(K+y+C));var ba=a.jgrid.getXmlData(F,l.cell,!0);a.each(O,function(a){var b=ba[this];if(!b)return!1;A=b.textContent||b.text;z[d.p.colModel[a+K+y+C].name]=A;E.push(u(J,A,a+K+y+C,G+e,F,z))})}else for(m=0;m<
I.length;m++)A=a.jgrid.getXmlData(F,I[m]),z[d.p.colModel[m+K+y+C].name]=A,E.push(u(J,A,m+K+y+C,G+e,F,z));E[ca]=D(J,V,ha,z,F,!1);E.push("</tr>");d.p.grouping&&(T.push(E),d.p.groupingView._locgr||S.call(n,z,G),E=[]);if(k||!0===d.p.treeGrid)z._id_=a.jgrid.stripPref(d.p.idPrefix,J),d.p.data.push(z),d.p._index[z._id_]=d.p.data.length-1;!1===d.p.gridview&&(a("tbody:first",c).append(E.join("")),n.triggerHandler("jqGridAfterInsertRow",[J,z,F]),h&&d.p.afterInsertRow.call(d,J,z,F),E=[]);z={};t++;G++;if(t===
...
-1;d.p.userDataOnFooter&&n.jqGrid("footerData","set",d.p.userData,!0);k&&(d.p.records=R,d.p.lastpage=Math.ceil(R/L));f||d.updatepager(!1,!0);if(k){for(;t<R;){F=b[t];J=p(F,t+N);J=d.p.idPrefix+J;if(l.repeatitems){O||(O=B(K+y+C));var aa=a.jgrid.getXmlData(F,l.cell,!0);a.each(O,function(a){var b=aa[this];if(!b)return!1;A=b.textContent||b.text;z[d.p.colModel[a+K+y+C].name]=A})}else for(m=0;m<I.length;m++)A=a.jgrid.getXmlData(F,I[m]),z[d.p.colModel[m+K+y+C].name]=A;z._id_=a.jgrid.stripPref(d.p.idPrefix,
...
d.p.colModel[F+K+y+C]&&(E=a.jgrid.getAccessor(h,d.p.colModel[F+K+y+C].name)),void 0===E&&(E=T+q,0===A.length&&c.cell&&(m=a.jgrid.getAccessor(h,c.cell)||h,E=null!=m&&void 0!==m[F]?m[F]:E)));E=d.p.idPrefix+E;m=1===e?0:e;R=1===(m+q)%2?ha:"";L&&(S=d.p.multiselect?-1!==a.inArray(E,d.p.selarrrow):E===d.p.selrow);var $=G.length;G.push("");C&&G.push(s(0,q,d.p.page,d.p.rowNum));K&&G.push(x(E,C,q,S));y&&G.push(Z.call(p,K+C,q+e));I=k;c.repeatitems&&(c.cell&&(h=a.jgrid.getAccessor(h,c.cell)||h),a.isArray(h)&&
(I=H));for(t=0;t<I.length;t++)m=a.jgrid.getAccessor(h,I[t]),J[d.p.colModel[t+K+y+C].name]=m,G.push(u(E,m,t+K+y+C,q+e,h,J));G[$]=D(E,ca,R,J,h,S);G.push("</tr>");d.p.grouping&&(V.push(G),d.p.groupingView._locgr||ba.call(p,J,q),G=[]);if(l||!0===d.p.treeGrid)J._id_=a.jgrid.stripPref(d.p.idPrefix,E),d.p.data.push(J),d.p._index[J._id_]=d.p.data.length-1;!1===d.p.gridview&&(a("#"+a.jgrid.jqID(d.p.id)+" tbody:first").append(G.join("")),p.triggerHandler("jqGridAfterInsertRow",[E,J,h]),N&&d.p.afterInsertRow.call(d,
...
d.p.jsonReader);d.p.localReader=a.extend(!0,{root:"rows",page:"page",total:"total",records:"records",repeatitems:!1,cell:"cell",id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},d.p.localReader);d.p.scroll&&(d.p.pgbuttons=!1,d.p.pginput=!1,d.p.rowList=[]);d.p.data.length&&(H(),A());N="<thead><tr class='ui-jqgrid-labels' role='row'>";var J,O,V,T,R,G,I,ea,ca=ea="",ga=[],ba=[];O=[];if(!0===d.p.shrinkToFit&&!0===d.p.forceFit)for(k=d.p.colModel.length-1;0<=k;k--)if(!d.p.colModel[k].hidden){d.p.colModel[k].resizable=
...
b)}}}).bind("reloadGrid",function(b,c){!0===d.p.treeGrid&&(d.p.datatype=d.p.treedatatype);c&&c.current&&d.grid.selectionPreserver(d);"local"===d.p.datatype?(a(d).jqGrid("resetSelection"),d.p.data.length&&(H(),A())):d.p.treeGrid||(d.p.selrow=null,d.p.multiselect&&(d.p.selarrrow=[],P(!1)),d.p.savedRow=[]);d.p.scroll&&v.call(d,!0,!1);if(c&&c.page){var e=c.page;e>d.p.lastpage&&(e=d.p.lastpage);1>e&&(e=1);d.p.page=e;d.grid.bDiv.scrollTop=d.grid.prevRowHeight?(e-1)*d.grid.prevRowHeight*d.p.rowNum:0}d.grid.prevRowHeight&&
...
c);var u;e.p.searchurl&&(u=e.p.url,a(e).jqGrid("setGridParam",{url:e.p.searchurl}));var x="stop"===a(e).triggerHandler("jqGridToolbarBeforeSearch")?!0:!1;!x&&a.isFunction(b.beforeSearch)&&(x=b.beforeSearch.call(e));x||a(e).jqGrid("setGridParam",{search:q}).trigger("reloadGrid",[{page:1}]);u&&a(e).jqGrid("setGridParam",{url:u});a(e).triggerHandler("jqGridToolbarAfterSearch");a.isFunction(b.afterSearch)&&b.afterSearch.call(e)},f=function(d,f,g){a("#sopt_menu").remove();f=parseInt(f,10);g=parseInt(g,
...
k.name});l.attr&&a("select",n).attr(l.attr);a("select",n).css({width:"100%"});a.jgrid.bindEv.call(e,a("select",n)[0],l);!0===b.autosearch&&a("select",n).change(function(){c();return!1});d=null}},a.jgrid.ajaxOptions,e.p.ajaxSelectOptions||{}));else{var u,x,s;k.searchoptions?(u=void 0===k.searchoptions.value?"":k.searchoptions.value,x=void 0===k.searchoptions.separator?":":k.searchoptions.separator,s=void 0===k.searchoptions.delimiter?";":k.searchoptions.delimiter):k.editoptions&&(u=void 0===k.editoptions.value?
"":k.editoptions.value,x=void 0===k.editoptions.separator?":":k.editoptions.separator,s=void 0===k.editoptions.delimiter?";":k.editoptions.delimiter);if(u){var w=document.createElement("select");w.style.width="100%";a(w).attr({name:k.index||k.name,id:"gs_"+k.name});var B;if("string"===typeof u)for(p=u.split(s),B=0;B<p.length;B++)u=p[B].split(x),s=document.createElement("option"),s.value=u[0],s.innerHTML=u[1],w.appendChild(s);else if("object"===typeof u)for(B in u)u.hasOwnProperty(B)&&(s=document.createElement("option"),
s.value=B,s.innerHTML=u[B],w.appendChild(s));void 0!==l.defaultValue&&a(w).val(l.defaultValue);l.attr&&a(w).attr(l.attr);a(n).append(t);a.jgrid.bindEv.call(e,w,l);a("td:eq(1)",t).append(w);!0===b.autosearch&&a(w).change(function(){c();return!1})}}break;case "text":x=void 0!==l.defaultValue?l.defaultValue:"";a("td:eq(1)",t).append("<input type='text' style='width:100%;padding:0px;' name='"+(k.index||k.name)+"' id='gs_"+k.name+"' value='"+x+"'/>");a(n).append(t);l.attr&&a("input",n).attr(l.attr);a.jgrid.bindEv.call(e,
a("input",n)[0],l);!0===b.autosearch&&(b.searchOnEnter?a("input",n).keypress(function(a){return 13===(a.charCode||a.keyCode||0)?(c(),!1):this}):a("input",n).keydown(function(a){switch(a.which){case 13:return!1;case 9:case 16:case 37:case 38:case 39:case 40:case 27:break;default:d&&clearTimeout(d),d=setTimeout(function(){c()},b.autosearchDelay)}}));break;case "custom":a("td:eq(1)",t).append("<span style='width:95%;padding:0px;' name='"+(k.index||k.name)+"' id='gs_"+k.name+"'/>");a(n).append(t);try{if(a.isFunction(l.custom_element))if(w=
l.custom_element.call(e,void 0!==l.defaultValue?l.defaultValue:"",l))w=a(w).addClass("customelement"),a(n).find("span[name='"+(k.index||k.name)+"']").append(w);else throw"e2";else throw"e1";}catch(v){"e1"===v&&a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_element' "+a.jgrid.edit.msg.nodefined,a.jgrid.edit.bClose),"e2"===v?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_element' "+a.jgrid.edit.msg.novalue,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,"string"===
...
c[0])[0])try{a("input.hasDatepicker",c[0]).datepicker("hide")}catch(m){}a(document).mousemove(a.jqDnR.drag).mouseup(a.jqDnR.stop);return!1})})},h=function(a){return parseInt(c.css(a),10)||!1},k=function(a){return parseInt(f.css(a),10)||!1}})(jQuery);
...
function(){void 0===b.groups&&(b.groups=[]);b.groups.push({groupOp:f.groupOps[0].op,rules:[],groups:[]});d.reDraw();d.onchange();return!1}));g.append(k);if(!0===this.p.ruleButtons){var k=a("<input type='button' value='+' title='Add rule' class='add-rule ui-add'/>"),w;k.bind("click",function(){void 0===b.rules&&(b.rules=[]);for(e=0;e<d.p.columns.length;e++){var c=void 0===d.p.columns[e].search?!0:d.p.columns[e].search,f=!0===d.p.columns[e].hidden;if(!0===d.p.columns[e].searchoptions.searchhidden&&
c||c&&!f){w=d.p.columns[e];break}}c=w.searchoptions.sopt?w.searchoptions.sopt:d.p.sopt?d.p.sopt:-1!==a.inArray(w.searchtype,d.p.strarr)?d.p.stropts:d.p.numopts;b.rules.push({field:w.name,op:c[0],data:""});d.reDraw();return!1});g.append(k)}null!==c&&(k=a("<input type='button' value='-' title='Delete group' class='delete-group'/>"),g.append(k),k.bind("click",function(){for(e=0;e<c.groups.length;e++)if(c.groups[e]===b){c.groups.splice(e,1);break}d.reDraw();d.onchange();return!1}));if(void 0!==b.groups)for(e=
0;e<b.groups.length;e++)g=a("<tr></tr>"),h.append(g),k=a("<td class='first'></td>"),g.append(k),k=a("<td colspan='4'></td>"),k.append(this.createTableForGroup(b.groups[e],b)),g.append(k);void 0===b.groupOp&&(b.groupOp=d.p.groupOps[0].op);if(void 0!==b.rules)for(e=0;e<b.rules.length;e++)h.append(this.createTableRowForRule(b.rules[e],b));return h};this.createTableRowForRule=function(b,c){var d=this,e=a("#"+a.jgrid.jqID(f.id))[0]||null,h=a("<tr></tr>"),g,l,x,s,w="",B;h.append("<td class='first'></td>");
var v=a("<td class='columns'></td>");h.append(v);var H=a("<select></select>"),A,D=[];v.append(H);H.bind("change",function(){b.field=a(H).val();x=a(this).parents("tr:first");for(g=0;g<d.p.columns.length;g++)if(d.p.columns[g].name===b.field){s=d.p.columns[g];break}if(s){s.searchoptions.id=a.jgrid.randId();k&&"text"===s.inputtype&&!s.searchoptions.size&&(s.searchoptions.size=10);var c=a.jgrid.createEl.call(e,s.inputtype,s.searchoptions,"",!0,d.p.ajaxSelectOptions||{},!0);a(c).addClass("input-elm");l=
s.searchoptions.sopt?s.searchoptions.sopt:d.p.sopt?d.p.sopt:-1!==a.inArray(s.searchtype,d.p.strarr)?d.p.stropts:d.p.numopts;var f="",h=0;D=[];a.each(d.p.ops,function(){D.push(this.oper)});for(g=0;g<l.length;g++)A=a.inArray(l[g],D),-1!==A&&(0===h&&(b.op=d.p.ops[A].oper),f+="<option value='"+d.p.ops[A].oper+"'>"+d.p.ops[A].text+"</option>",h++);a(".selectopts",x).empty().append(f);a(".selectopts",x)[0].selectedIndex=0;a.jgrid.msie&&9>a.jgrid.msiever()&&(f=parseInt(a("select.selectopts",x)[0].offsetWidth,
10)+1,a(".selectopts",x).width(f),a(".selectopts",x).css("width","auto"));a(".data",x).empty().append(c);a.jgrid.bindEv.call(e,c,s.searchoptions);a(".input-elm",x).bind("change",function(c){c=c.target;b.data="SPAN"===c.nodeName.toUpperCase()&&s.searchoptions&&a.isFunction(s.searchoptions.custom_value)?s.searchoptions.custom_value.call(e,a(c).children(".customelement:first"),"get"):c.value;d.onchange()});setTimeout(function(){b.data=a(c).val();d.onchange()},0)}});for(g=v=0;g<d.p.columns.length;g++){B=
void 0===d.p.columns[g].search?!0:d.p.columns[g].search;var C=!0===d.p.columns[g].hidden;if(!0===d.p.columns[g].searchoptions.searchhidden&&B||B&&!C)B="",b.field===d.p.columns[g].name&&(B=" selected='selected'",v=g),w+="<option value='"+d.p.columns[g].name+"'"+B+">"+d.p.columns[g].label+"</option>"}H.append(w);w=a("<td class='operators'></td>");h.append(w);s=f.columns[v];s.searchoptions.id=a.jgrid.randId();k&&"text"===s.inputtype&&!s.searchoptions.size&&(s.searchoptions.size=10);v=a.jgrid.createEl.call(e,
s.inputtype,s.searchoptions,b.data,!0,d.p.ajaxSelectOptions||{},!0);if("nu"===b.op||"nn"===b.op)a(v).attr("readonly","true"),a(v).attr("disabled","true");var F=a("<select class='selectopts'></select>");w.append(F);F.bind("change",function(){b.op=a(F).val();x=a(this).parents("tr:first");var c=a(".input-elm",x)[0];"nu"===b.op||"nn"===b.op?(b.data="","SELECT"!==c.tagName.toUpperCase()&&(c.value=""),c.setAttribute("readonly","true"),c.setAttribute("disabled","true")):("SELECT"===c.tagName.toUpperCase()&&
(b.data=c.value),c.removeAttribute("readonly"),c.removeAttribute("disabled"));d.onchange()});l=s.searchoptions.sopt?s.searchoptions.sopt:d.p.sopt?d.p.sopt:-1!==a.inArray(s.searchtype,d.p.strarr)?d.p.stropts:d.p.numopts;w="";a.each(d.p.ops,function(){D.push(this.oper)});for(g=0;g<l.length;g++)A=a.inArray(l[g],D),-1!==A&&(B=b.op===d.p.ops[A].oper?" selected='selected'":"",w+="<option value='"+d.p.ops[A].oper+"'"+B+">"+d.p.ops[A].text+"</option>");F.append(w);w=a("<td class='data'></td>");h.append(w);
w.append(v);a.jgrid.bindEv.call(e,v,s.searchoptions);a(v).addClass("input-elm").bind("change",function(){b.data="custom"===s.inputtype?s.searchoptions.custom_value.call(e,a(this).children(".customelement:first"),"get"):a(this).val();d.onchange()});w=a("<td></td>");h.append(w);!0===this.p.ruleButtons&&(v=a("<input type='button' value='-' title='Delete rule' class='delete-rule ui-del'/>"),w.append(v),v.bind("click",function(){for(g=0;g<c.rules.length;g++)if(c.rules[g]===b){c.rules.splice(g,1);break}d.reDraw();
...
b.Find+"</a>",u="<a id='"+g+"_reset' class='fm-button ui-state-default ui-corner-all fm-button-icon-left ui-search'><span class='ui-icon ui-icon-arrowreturnthick-1-w'></span>"+b.Reset+"</a>",x="",s="",w,B=!1,v=-1;b.showQuery&&(x="<a id='"+g+"_query' class='fm-button ui-state-default ui-corner-all fm-button-icon-left'><span class='ui-icon ui-icon-comment'></span>Query</a>");b.columns.length?(n=b.columns,v=0,w=n[0].index||n[0].name):a.each(n,function(a,b){b.label||(b.label=f.p.colNames[a]);if(!B){var c=
void 0===b.search?!0:b.search,d=!0===b.hidden;if(b.searchoptions&&!0===b.searchoptions.searchhidden&&c||c&&!d)B=!0,w=b.index||b.name,v=a}});if(!l&&w||!1===b.multipleSearch){var H="eq";0<=v&&n[v].searchoptions&&n[v].searchoptions.sopt?H=n[v].searchoptions.sopt[0]:b.sopt&&b.sopt.length&&(H=b.sopt[0]);l={groupOp:"AND",rules:[{field:w,op:H,data:""}]}}B=!1;b.tmplNames&&b.tmplNames.length&&(B=!0,s=b.tmplLabel,s+="<select class='ui-template'>",s+="<option value='default'>Default</option>",a.each(b.tmplNames,
function(a,b){s+="<option value='"+a+"'>"+b+"</option>"}),s+="</select>");r="<table class='EditTable' style='border:0px none;margin-top:5px' id='"+g+"_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='EditButton' style='text-align:"+r+"'>"+u+s+"</td><td class='EditButton' "+q+">"+x+t+"</td></tr></tbody></table>";g=a.jgrid.jqID(g);a("#"+g).jqFilter({columns:n,filter:b.loadDefaults?l:null,showQuery:b.showQuery,errorcheck:b.errorcheck,sopt:b.sopt,
...
break;case "password":case "text":case "textarea":case "button":y[this.name]=a(this).val()}n.p.autoencode&&(y[this.name]=a.jgrid.htmlEncode(y[this.name]))}});return!0}function g(c,d,e,f){var h,g,k,l=0,p,m,q,r=[],s=!1,t="",v;for(v=1;v<=f;v++)t+="<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>";"_empty"!==c&&(s=a(d).jqGrid("getInd",c));a(d.p.colModel).each(function(v){h=this.name;m=(g=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";
if("cb"!==h&&"subgrid"!==h&&!0===this.editable&&"rn"!==h){if(!1===s)p="";else if(h===d.p.ExpandColumn&&!0===d.p.treeGrid)p=a("td[role='gridcell']:eq("+v+")",d.rows[s]).text();else{try{p=a.unformat.call(d,a("td[role='gridcell']:eq("+v+")",d.rows[s]),{rowId:c,colModel:this},v)}catch(w){p=this.edittype&&"textarea"===this.edittype?a("td[role='gridcell']:eq("+v+")",d.rows[s]).text():a("td[role='gridcell']:eq("+v+")",d.rows[s]).html()}if(!p||"&nbsp;"===p||"&#160;"===p||1===p.length&&160===p.charCodeAt(0))p=
""}var D=a.extend({},this.editoptions||{},{id:h,name:h,rowId:c}),x=a.extend({},{elmprefix:"",elmsuffix:"",rowabove:!1,rowcontent:""},this.formoptions||{}),B=parseInt(x.rowpos,10)||l+1,y=parseInt(2*(parseInt(x.colpos,10)||1),10);"_empty"===c&&D.defaultValue&&(p=a.isFunction(D.defaultValue)?D.defaultValue.call(n):D.defaultValue);this.edittype||(this.edittype="text");n.p.autoencode&&(p=a.jgrid.htmlDecode(p));q=a.jgrid.createEl.call(n,this.edittype,D,p,!1,a.extend({},a.jgrid.ajaxOptions,d.p.ajaxSelectOptions||
{}));if(b[n.p.id].checkOnSubmit||b[n.p.id].checkOnUpdate)b[n.p.id]._savedData[h]=p;a(q).addClass("FormElement");-1<a.inArray(this.edittype,["text","textarea","password","select"])&&a(q).addClass("ui-widget-content ui-corner-all");k=a(e).find("tr[rowpos="+B+"]");if(x.rowabove){var C=a("<tr><td class='contentinfo' colspan='"+2*f+"'>"+x.rowcontent+"</td></tr>");a(e).append(C);C[0].rp=B}0===k.length&&(k=a("<tr "+m+" rowpos='"+B+"'></tr>").addClass("FormData").attr("id","tr_"+h),a(k).append(t),a(e).append(k),
k[0].rp=B);a("td:eq("+(y-2)+")",k[0]).html(void 0===x.label?d.p.colNames[v]:x.label);a("td:eq("+(y-1)+")",k[0]).append(x.elmprefix).append(q).append(x.elmsuffix);"custom"===this.edittype&&a.isFunction(D.custom_value)&&D.custom_value.call(n,a("#"+h,"#"+u),"set",p);a.jgrid.bindEv.call(n,q,D);r[l]=v;l++}});0<l&&(v=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(2*f-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='"+d.p.id+"_id' value='"+
c+"'/></td></tr>"),v[0].rp=l+999,a(e).append(v),b[n.p.id].checkOnSubmit||b[n.p.id].checkOnUpdate)&&(b[n.p.id]._savedData[d.p.id+"_id"]=c);return r}function d(c,d,e){var f,h=0,g,k,l,p,m;if(b[n.p.id].checkOnSubmit||b[n.p.id].checkOnUpdate)b[n.p.id]._savedData={},b[n.p.id]._savedData[d.p.id+"_id"]=c;var q=d.p.colModel;if("_empty"===c)a(q).each(function(){f=this.name;l=a.extend({},this.editoptions||{});(k=a("#"+a.jgrid.jqID(f),"#"+e))&&k.length&&null!==k[0]&&(p="","custom"===this.edittype&&a.isFunction(l.custom_value)?
l.custom_value.call(n,a("#"+f,"#"+e),"set",p):l.defaultValue?(p=a.isFunction(l.defaultValue)?l.defaultValue.call(n):l.defaultValue,"checkbox"===k[0].type?(m=p.toLowerCase(),0>m.search(/(false|f|0|no|n|off|undefined)/i)&&""!==m?(k[0].checked=!0,k[0].defaultChecked=!0,k[0].value=p):(k[0].checked=!1,k[0].defaultChecked=!1)):k.val(p)):"checkbox"===k[0].type?(k[0].checked=!1,k[0].defaultChecked=!1,p=a(k).attr("offval")):k[0].type&&"select"===k[0].type.substr(0,6)?k[0].selectedIndex=0:k.val(p),!0===b[n.p.id].checkOnSubmit||
b[n.p.id].checkOnUpdate)&&(b[n.p.id]._savedData[f]=p)}),a("#id_g","#"+e).val(c);else{var r=a(d).jqGrid("getInd",c,!0);r&&(a('td[role="gridcell"]',r).each(function(k){f=q[k].name;if("cb"!==f&&"subgrid"!==f&&"rn"!==f&&!0===q[k].editable){if(f===d.p.ExpandColumn&&!0===d.p.treeGrid)g=a(this).text();else try{g=a.unformat.call(d,a(this),{rowId:c,colModel:q[k]},k)}catch(l){g="textarea"===q[k].edittype?a(this).text():a(this).html()}n.p.autoencode&&(g=a.jgrid.htmlDecode(g));if(!0===b[n.p.id].checkOnSubmit||
b[n.p.id].checkOnUpdate)b[n.p.id]._savedData[f]=g;f=a.jgrid.jqID(f);switch(q[k].edittype){case "password":case "text":case "button":case "image":case "textarea":if("&nbsp;"===g||"&#160;"===g||1===g.length&&160===g.charCodeAt(0))g="";a("#"+f,"#"+e).val(g);break;case "select":var p=g.split(","),p=a.map(p,function(b){return a.trim(b)});a("#"+f+" option","#"+e).each(function(){q[k].editoptions.multiple||a.trim(g)!==a.trim(a(this).text())&&p[0]!==a.trim(a(this).text())&&p[0]!==a.trim(a(this).val())?q[k].editoptions.multiple?
-1<a.inArray(a.trim(a(this).text()),p)||-1<a.inArray(a.trim(a(this).val()),p)?this.selected=!0:this.selected=!1:this.selected=!1:this.selected=!0});break;case "checkbox":g=String(g);if(q[k].editoptions&&q[k].editoptions.value)if(q[k].editoptions.value.split(":")[0]===g)a("#"+f,"#"+e)[n.p.useProp?"prop":"attr"]({checked:!0,defaultChecked:!0});else a("#"+f,"#"+e)[n.p.useProp?"prop":"attr"]({checked:!1,defaultChecked:!1});else g=g.toLowerCase(),0>g.search(/(false|f|0|no|n|off|undefined)/i)&&""!==g?(a("#"+
f,"#"+e)[n.p.useProp?"prop":"attr"]("checked",!0),a("#"+f,"#"+e)[n.p.useProp?"prop":"attr"]("defaultChecked",!0)):(a("#"+f,"#"+e)[n.p.useProp?"prop":"attr"]("checked",!1),a("#"+f,"#"+e)[n.p.useProp?"prop":"attr"]("defaultChecked",!1));break;case "custom":try{if(q[k].editoptions&&a.isFunction(q[k].editoptions.custom_value))q[k].editoptions.custom_value.call(n,a("#"+f,"#"+e),"set",g);else throw"e1";}catch(m){"e1"===m?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_value' "+a.jgrid.edit.msg.nodefined,
a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,m.message,a.jgrid.edit.bClose)}}h++}}),0<h&&a("#id_g",s).val(c))}}function h(){a.each(n.p.colModel,function(a,b){b.editoptions&&!0===b.editoptions.NullIfEmpty&&y.hasOwnProperty(b.name)&&""===y[b.name]&&(y[b.name]="null")})}function k(){var e,f=[!0,"",""],g={},k=n.p.prmNames,l,p,m,q,r,v=a(n).triggerHandler("jqGridAddEditBeforeCheckValues",[a("#"+u),z]);v&&"object"===typeof v&&(y=v);a.isFunction(b[n.p.id].beforeCheckValues)&&(v=b[n.p.id].beforeCheckValues.call(n,
y,a("#"+u),z))&&"object"===typeof v&&(y=v);for(m in y)if(y.hasOwnProperty(m)&&(f=a.jgrid.checkValues.call(n,y[m],m),!1===f[0]))break;h();f[0]&&(g=a(n).triggerHandler("jqGridAddEditClickSubmit",[b[n.p.id],y,z]),void 0===g&&a.isFunction(b[n.p.id].onclickSubmit)&&(g=b[n.p.id].onclickSubmit.call(n,b[n.p.id],y,z)||{}),f=a(n).triggerHandler("jqGridAddEditBeforeSubmit",[y,a("#"+u),z]),void 0===f&&(f=[!0,"",""]),f[0]&&a.isFunction(b[n.p.id].beforeSubmit)&&(f=b[n.p.id].beforeSubmit.call(n,y,a("#"+u),z)));
if(f[0]&&!b[n.p.id].processing){b[n.p.id].processing=!0;a("#sData",s+"_2").addClass("ui-state-active");m=b[n.p.id].url||a(n).jqGrid("getGridParam","editurl");p=k.oper;l="clientArray"===m?n.p.keyName:k.id;y[p]="_empty"===a.trim(y[n.p.id+"_id"])?k.addoper:k.editoper;y[p]!==k.addoper?y[l]=y[n.p.id+"_id"]:void 0===y[l]&&(y[l]=y[n.p.id+"_id"]);delete y[n.p.id+"_id"];y=a.extend(y,b[n.p.id].editData,g);if(!0===n.p.treeGrid)for(r in y[p]===k.addoper&&(q=a(n).jqGrid("getGridParam","selrow"),y["adjacency"===
n.p.treeGridModel?n.p.treeReader.parent_id_field:"parent_id"]=q),n.p.treeReader)n.p.treeReader.hasOwnProperty(r)&&(g=n.p.treeReader[r],!y.hasOwnProperty(g)||y[p]===k.addoper&&"parent_id_field"===r||delete y[g]);y[l]=a.jgrid.stripPref(n.p.idPrefix,y[l]);r=a.extend({url:m,type:b[n.p.id].mtype,data:a.isFunction(b[n.p.id].serializeEditData)?b[n.p.id].serializeEditData.call(n,y):y,complete:function(h,g){var m;a("#sData",s+"_2").removeClass("ui-state-active");y[l]=n.p.idPrefix+y[l];300<=h.status&&304!==
h.status?(f[0]=!1,f[1]=a(n).triggerHandler("jqGridAddEditErrorTextFormat",[h,z]),a.isFunction(b[n.p.id].errorTextFormat)?f[1]=b[n.p.id].errorTextFormat.call(n,h,z):f[1]=g+" Status: '"+h.statusText+"'. Error code: "+h.status):(f=a(n).triggerHandler("jqGridAddEditAfterSubmit",[h,y,z]),void 0===f&&(f=[!0,"",""]),f[0]&&a.isFunction(b[n.p.id].afterSubmit)&&(f=b[n.p.id].afterSubmit.call(n,h,y,z)));if(!1===f[0])a("#FormError>td",s).html(f[1]),a("#FormError",s).show();else if(n.p.autoencode&&a.each(y,function(b,
c){y[b]=a.jgrid.htmlDecode(c)}),y[p]===k.addoper?(f[2]||(f[2]=a.jgrid.randId()),null==y[l]||"_empty"===y[l]?y[l]=f[2]:f[2]=y[l],b[n.p.id].reloadAfterSubmit?a(n).trigger("reloadGrid"):!0===n.p.treeGrid?a(n).jqGrid("addChildNode",f[2],q,y):a(n).jqGrid("addRowData",f[2],y,c.addedrow),b[n.p.id].closeAfterAdd?(!0!==n.p.treeGrid&&a(n).jqGrid("setSelection",f[2]),a.jgrid.hideModal("#"+a.jgrid.jqID(w.themodal),{gb:"#gbox_"+a.jgrid.jqID(t),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,
formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form})):b[n.p.id].clearAfterAdd&&d("_empty",n,u)):(b[n.p.id].reloadAfterSubmit?(a(n).trigger("reloadGrid"),b[n.p.id].closeAfterEdit||setTimeout(function(){a(n).jqGrid("setSelection",y[l])},1E3)):!0===n.p.treeGrid?a(n).jqGrid("setTreeRow",y[l],y):a(n).jqGrid("setRowData",y[l],y),b[n.p.id].closeAfterEdit&&a.jgrid.hideModal("#"+a.jgrid.jqID(w.themodal),{gb:"#gbox_"+a.jgrid.jqID(t),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,
formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form})),a.isFunction(b[n.p.id].afterComplete)&&(e=h,setTimeout(function(){a(n).triggerHandler("jqGridAddEditAfterComplete",[e,y,a("#"+u),z]);b[n.p.id].afterComplete.call(n,e,y,a("#"+u),z);e=null},500)),b[n.p.id].checkOnSubmit||b[n.p.id].checkOnUpdate)if(a("#"+u).data("disabled",!1),"_empty"!==b[n.p.id]._savedData[n.p.id+"_id"])for(m in b[n.p.id]._savedData)b[n.p.id]._savedData.hasOwnProperty(m)&&y[m]&&(b[n.p.id]._savedData[m]=y[m]);b[n.p.id].processing=
!1;try{a(":input:visible","#"+u)[0].focus()}catch(r){}}},a.jgrid.ajaxOptions,b[n.p.id].ajaxEditOptions);r.url||b[n.p.id].useDataProxy||(a.isFunction(n.p.dataProxy)?b[n.p.id].useDataProxy=!0:(f[0]=!1,f[1]+=" "+a.jgrid.errors.nourl));f[0]&&(b[n.p.id].useDataProxy?(g=n.p.dataProxy.call(n,r,"set_"+n.p.id),void 0===g&&(g=[!0,""]),!1===g[0]?(f[0]=!1,f[1]=g[1]||"Error deleting the selected row!"):(r.data.oper===k.addoper&&b[n.p.id].closeAfterAdd&&a.jgrid.hideModal("#"+a.jgrid.jqID(w.themodal),{gb:"#gbox_"+
a.jgrid.jqID(t),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form}),r.data.oper===k.editoper&&b[n.p.id].closeAfterEdit&&a.jgrid.hideModal("#"+a.jgrid.jqID(w.themodal),{gb:"#gbox_"+a.jgrid.jqID(t),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form}))):"clientArray"===r.url?(b[n.p.id].reloadAfterSubmit=!1,y=r.data,r.complete({status:200,statusText:""},
...
s+"_2").addClass("ui-state-disabled"):a("#nData",s+"_2").removeClass("ui-state-disabled")}function q(){var b=a(n).jqGrid("getDataIDs"),c=a("#id_g",s).val();return[a.inArray(c,b),b]}var n=this;if(n.grid&&e){var t=n.p.id,u="FrmGrid_"+t,x="TblGrid_"+t,s="#"+a.jgrid.jqID(x),w={themodal:"editmod"+t,modalhead:"edithd"+t,modalcontent:"editcnt"+t,scrollelm:u},B=a.isFunction(b[n.p.id].beforeShowForm)?b[n.p.id].beforeShowForm:!1,v=a.isFunction(b[n.p.id].afterShowForm)?b[n.p.id].afterShowForm:!1,H=a.isFunction(b[n.p.id].beforeInitData)?
b[n.p.id].beforeInitData:!1,A=a.isFunction(b[n.p.id].onInitializeForm)?b[n.p.id].onInitializeForm:!1,D=!0,C=1,F=0,y,M,z,u=a.jgrid.jqID(u);"new"===e?(e="_empty",z="add",c.caption=b[n.p.id].addCaption):(c.caption=b[n.p.id].editCaption,z="edit");c.recreateForm||a(n).data("formProp")&&a.extend(b[a(this)[0].p.id],a(n).data("formProp"));var L=!0;c.checkOnUpdate&&c.jqModal&&!c.modal&&(L=!1);var P=isNaN(b[a(this)[0].p.id].dataheight)?b[a(this)[0].p.id].dataheight:b[a(this)[0].p.id].dataheight+"px",D=isNaN(b[a(this)[0].p.id].datawidth)?
b[a(this)[0].p.id].datawidth:b[a(this)[0].p.id].datawidth+"px",P=a("<form name='FormPost' id='"+u+"' class='FormGrid' onSubmit='return false;' style='width:"+D+";overflow:auto;position:relative;height:"+P+";'></form>").data("disabled",!1),U=a("<table id='"+x+"' class='EditTable' cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>");a(n.p.colModel).each(function(){var a=this.formoptions;C=Math.max(C,a?a.colpos||0:0);F=Math.max(F,a?a.rowpos||0:0)});a(P).append(U);D=a("<tr id='FormError' style='display:none'><td class='ui-state-error' colspan='"+
...
(H?X+D:D+X)+"</td><td class='EditButton'>"+E+aa+"</td></tr>"+("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"+b[n.p.id].bottominfo+"</td></tr>"),x=x+"</tbody></table>";if(0<F){var S=[];a.each(a(U)[0].rows,function(a,b){S[a]=b});S.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(S,function(b,c){a("tbody",U).append(c)})}c.gbox="#gbox_"+a.jgrid.jqID(t);var N=!1;!0===c.closeOnEscape&&(c.closeOnEscape=!1,N=!0);x=a("<div></div>").append(P).append(x);a.jgrid.createModal(w,
x,b[a(this)[0].p.id],"#gview_"+a.jgrid.jqID(n.p.id),a("#gbox_"+a.jgrid.jqID(n.p.id))[0]);H&&(a("#pData, #nData",s+"_2").css("float","right"),a(".EditButton",s+"_2").css("text-align","left"));b[n.p.id].topinfo&&a(".tinfo",s).show();b[n.p.id].bottominfo&&a(".binfo",s+"_2").show();x=x=null;a("#"+a.jgrid.jqID(w.themodal)).keydown(function(d){var e=d.target;if(!0===a("#"+u).data("disabled"))return!1;if(!0===b[n.p.id].savekey[0]&&d.which===b[n.p.id].savekey[1]&&"TEXTAREA"!==e.tagName)return a("#sData",
s+"_2").trigger("click"),!1;if(27===d.which){if(!p())return!1;N&&a.jgrid.hideModal("#"+a.jgrid.jqID(w.themodal),{gb:c.gbox,jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form});return!1}if(!0===b[n.p.id].navkeys[0]){if("_empty"===a("#id_g",s).val())return!0;if(d.which===b[n.p.id].navkeys[1])return a("#pData",s+"_2").trigger("click"),!1;if(d.which===b[n.p.id].navkeys[2])return a("#nData",s+"_2").trigger("click"),!1}});c.checkOnUpdate&&
(a("a.ui-jqdialog-titlebar-close span","#"+a.jgrid.jqID(w.themodal)).removeClass("jqmClose"),a("a.ui-jqdialog-titlebar-close","#"+a.jgrid.jqID(w.themodal)).unbind("click").click(function(){if(!p())return!1;a.jgrid.hideModal("#"+a.jgrid.jqID(w.themodal),{gb:"#gbox_"+a.jgrid.jqID(t),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form});return!1}));c.saveicon=a.extend([!0,"left","ui-icon-disk"],c.saveicon);c.closeicon=a.extend([!0,
...
c.bYes+"</a>",X="<a id='nNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+c.bNo+"</a>",aa="<a id='cNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+c.bExit+"</a>",x=c.zIndex||999,x++,a("<div class='"+c.overlayClass+" jqgrid-overlay confirm' style='z-index:"+x+";display:none;'>&#160;</div><div class='confirm ui-widget-content ui-jqconfirm' style='z-index:"+(x+1)+"'>"+c.saveData+"<br/><br/>"+E+X+aa+"</div>").insertAfter("#"+u),a("#sNew","#"+a.jgrid.jqID(w.themodal)).click(function(){k();
a("#"+u).data("disabled",!1);a(".confirm","#"+a.jgrid.jqID(w.themodal)).hide();return!1}),a("#nNew","#"+a.jgrid.jqID(w.themodal)).click(function(){a(".confirm","#"+a.jgrid.jqID(w.themodal)).hide();a("#"+u).data("disabled",!1);setTimeout(function(){a(":input:visible","#"+u)[0].focus()},0);return!1}),a("#cNew","#"+a.jgrid.jqID(w.themodal)).click(function(){a(".confirm","#"+a.jgrid.jqID(w.themodal)).hide();a("#"+u).data("disabled",!1);a.jgrid.hideModal("#"+a.jgrid.jqID(w.themodal),{gb:"#gbox_"+a.jgrid.jqID(t),
jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form});return!1});a(n).triggerHandler("jqGridAddEditInitializeForm",[a("#"+u),z]);A&&A.call(n,a("#"+u),z);"_empty"!==e&&b[n.p.id].viewPagerButtons?a("#pData,#nData",s+"_2").show():a("#pData,#nData",s+"_2").hide();a(n).triggerHandler("jqGridAddEditBeforeShowForm",[a("#"+u),z]);B&&B.call(n,a("#"+u),z);a("#"+a.jgrid.jqID(w.themodal)).data("onClose",b[n.p.id].onClose);a.jgrid.viewModal("#"+
a.jgrid.jqID(w.themodal),{gbox:"#gbox_"+a.jgrid.jqID(t),jqm:c.jqModal,overlay:c.overlay,modal:c.modal,overlayClass:c.overlayClass,onHide:function(b){var c=a("#editmod"+t)[0].style.height;-1<c.indexOf("px")&&(c=parseFloat(c));a(n).data("formProp",{top:parseFloat(a(b.w).css("top")),left:parseFloat(a(b.w).css("left")),width:a(b.w).width(),height:c,dataheight:a("#"+u).height(),datawidth:a("#"+u).width()});b.w.remove();b.o&&b.o.remove()}});L||a("."+a.jgrid.jqID(c.overlayClass)).click(function(){if(!p())return!1;
a.jgrid.hideModal("#"+a.jgrid.jqID(w.themodal),{gb:"#gbox_"+a.jgrid.jqID(t),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form});return!1});a(".fm-button","#"+a.jgrid.jqID(w.themodal)).hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});a("#sData",s+"_2").click(function(){y={};a("#FormError",s).hide();f();"_empty"===y[n.p.id+"_id"]?k():!0===c.checkOnSubmit?(M=l(y,b[n.p.id]._savedData))?
(a("#"+u).data("disabled",!0),a(".confirm","#"+a.jgrid.jqID(w.themodal)).show()):k():k();return!1});a("#cData",s+"_2").click(function(){if(!p())return!1;a.jgrid.hideModal("#"+a.jgrid.jqID(w.themodal),{gb:"#gbox_"+a.jgrid.jqID(t),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form});return!1});a("#nData",s+"_2").click(function(){if(!p())return!1;a("#FormError",s).hide();var b=q();b[0]=parseInt(b[0],10);if(-1!==b[0]&&b[1][b[0]+
...
["prev",a("#"+u),b[1][b[0]]]);a.isFunction(c.afterclickPgButtons)&&c.afterclickPgButtons.call(n,"prev",a("#"+u),b[1][b[0]-1]);r(b[0]-1,b)}return!1});a(n).triggerHandler("jqGridAddEditAfterShowForm",[a("#"+u),z]);v&&v.call(n,a("#"+u),z);B=q();r(B[0],B)}}})},viewGridRow:function(e,c){c=a.extend(!0,{top:0,left:0,width:0,datawidth:"auto",height:"auto",dataheight:"auto",modal:!1,overlay:30,drag:!0,resize:!0,jqModal:!0,closeOnEscape:!1,labelswidth:"30%",closeicon:[],navkeys:[!1,38,40],onClose:null,beforeShowForm:null,
beforeInitData:null,viewPagerButtons:!0,recreateForm:!1,removemodal:!0,form:"view"},a.jgrid.view,c||{});b[a(this)[0].p.id]=c;return this.each(function(){function f(){!0!==b[l.p.id].closeOnEscape&&!0!==b[l.p.id].navkeys[0]||setTimeout(function(){a(".ui-jqdialog-titlebar-close","#"+a.jgrid.jqID(t.modalhead)).attr("tabindex","-1").focus()},0)}function g(b,d,e,f){var h,g,k,l=0,n,p,m=[],q=!1,r,s="<td class='CaptionTD form-view-label ui-widget-content' width='"+c.labelswidth+"'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content'>&#160;</td>",
u="",v=["integer","number","currency"],t=0,w=0,x,B,A;for(r=1;r<=f;r++)u+=1===r?s:"<td class='CaptionTD form-view-label ui-widget-content'>&#160;</td><td class='DataTD form-view-data ui-widget-content'>&#160;</td>";a(d.p.colModel).each(function(){(g=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)||"right"!==this.align||(this.formatter&&-1!==a.inArray(this.formatter,v)?t=Math.max(t,parseInt(this.width,10)):w=Math.max(w,parseInt(this.width,10)))});x=0!==t?t:0!==w?w:0;q=a(d).jqGrid("getInd",
b);a(d.p.colModel).each(function(b){h=this.name;B=!1;p=(g=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";A="boolean"!==typeof this.viewable?!0:this.viewable;if("cb"!==h&&"subgrid"!==h&&"rn"!==h&&A){n=!1===q?"":h===d.p.ExpandColumn&&!0===d.p.treeGrid?a("td:eq("+b+")",d.rows[q]).text():a("td:eq("+b+")",d.rows[q]).html();B="right"===this.align&&0!==x?!0:!1;var c=a.extend({},{rowabove:!1,rowcontent:""},this.formoptions||{}),r=parseInt(c.rowpos,10)||
l+1,s=parseInt(2*(parseInt(c.colpos,10)||1),10);if(c.rowabove){var t=a("<tr><td class='contentinfo' colspan='"+2*f+"'>"+c.rowcontent+"</td></tr>");a(e).append(t);t[0].rp=r}k=a(e).find("tr[rowpos="+r+"]");0===k.length&&(k=a("<tr "+p+" rowpos='"+r+"'></tr>").addClass("FormData").attr("id","trv_"+h),a(k).append(u),a(e).append(k),k[0].rp=r);a("td:eq("+(s-2)+")",k[0]).html("<b>"+(void 0===c.label?d.p.colNames[b]:c.label)+"</b>");a("td:eq("+(s-1)+")",k[0]).append("<span>"+n+"</span>").attr("id","v_"+h);
B&&a("td:eq("+(s-1)+") span",k[0]).css({"text-align":"right",width:x+"px"});m[l]=b;l++}});0<l&&(b=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(2*f-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='id' value='"+b+"'/></td></tr>"),b[0].rp=l+99,a(e).append(b));return m}function d(b,c){var d,e,f=0,h,g;if(g=a(c).jqGrid("getInd",b,!0))a("td",g).each(function(b){d=c.p.colModel[b].name;e=c.p.colModel[b].editrules&&!0===c.p.colModel[b].editrules.edithidden?
...
p,n="ViewTbl_"+p,t={themodal:"viewmod"+p,modalhead:"viewhd"+p,modalcontent:"viewcnt"+p,scrollelm:m},u=a.isFunction(b[l.p.id].beforeInitData)?b[l.p.id].beforeInitData:!1,x=!0,s=1,w=0;c.recreateForm||a(l).data("viewProp")&&a.extend(b[a(this)[0].p.id],a(l).data("viewProp"));var B=isNaN(b[a(this)[0].p.id].dataheight)?b[a(this)[0].p.id].dataheight:b[a(this)[0].p.id].dataheight+"px",v=isNaN(b[a(this)[0].p.id].datawidth)?b[a(this)[0].p.id].datawidth:b[a(this)[0].p.id].datawidth+"px",q=a("<form name='FormPost' id='"+
q+"' class='FormGrid' style='width:"+v+";overflow:auto;position:relative;height:"+B+";'></form>"),H=a("<table id='"+n+"' class='EditTable' cellspacing='1' cellpadding='2' border='0' style='table-layout:fixed'><tbody></tbody></table>");a(l.p.colModel).each(function(){var a=this.formoptions;s=Math.max(s,a?a.colpos||0:0);w=Math.max(w,a?a.rowpos||0:0)});a(q).append(H);u&&(x=u.call(l,q),void 0===x&&(x=!0));if(!1!==x){g(e,l,H,s);n="rtl"===l.p.direction?!0:!1;u="<a id='"+(n?"nData":"pData")+"' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>";
x="<a id='"+(n?"pData":"nData")+"' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>";B="<a id='cData' class='fm-button ui-state-default ui-corner-all'>"+c.bClose+"</a>";if(0<w){var A=[];a.each(a(H)[0].rows,function(a,b){A[a]=b});A.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(A,function(b,c){a("tbody",H).append(c)})}c.gbox="#gbox_"+a.jgrid.jqID(p);q=a("<div></div>").append(q).append("<table border='0' class='EditTable' id='"+
r+"_2'><tbody><tr id='Act_Buttons'><td class='navButton' width='"+c.labelswidth+"'>"+(n?x+u:u+x)+"</td><td class='EditButton'>"+B+"</td></tr></tbody></table>");a.jgrid.createModal(t,q,c,"#gview_"+a.jgrid.jqID(l.p.id),a("#gview_"+a.jgrid.jqID(l.p.id))[0]);n&&(a("#pData, #nData","#"+r+"_2").css("float","right"),a(".EditButton","#"+r+"_2").css("text-align","left"));c.viewPagerButtons||a("#pData, #nData","#"+r+"_2").hide();q=null;a("#"+t.themodal).keydown(function(d){if(27===d.which)return b[l.p.id].closeOnEscape&&
...
modal:b[f.p.id].modal})}else{var s=isNaN(b[f.p.id].dataheight)?b[f.p.id].dataheight:b[f.p.id].dataheight+"px",w=isNaN(c.datawidth)?c.datawidth:c.datawidth+"px",u="<div id='"+u+"' class='formdata' style='width:"+w+";overflow:auto;position:relative;height:"+s+";'><table class='DelTable'><tbody>",u=u+"<tr id='DelError' style='display:none'><td class='ui-state-error'></td></tr>",u=u+("<tr id='DelData' style='display:none'><td >"+e+"</td></tr>"),u=u+('<tr><td class="delmsg" style="white-space:pre;">'+
...
a.jgrid.jqID(k);a.jgrid.createModal(x,u,c,"#gview_"+a.jgrid.jqID(f.p.id),a("#gview_"+a.jgrid.jqID(f.p.id))[0]);h&&(p=h.call(f,a(u)),void 0===p&&(p=!0));if(!1===p)return;a(".fm-button","#"+m+"_2").hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});c.delicon=a.extend([!0,"left","ui-icon-scissors"],b[f.p.id].delicon);c.cancelicon=a.extend([!0,"left","ui-icon-cancel"],b[f.p.id].cancelicon);!0===c.delicon[0]&&a("#dData","#"+m+"_2").addClass("right"===
c.delicon[1]?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+c.delicon[2]+"'></span>");!0===c.cancelicon[0]&&a("#eData","#"+m+"_2").addClass("right"===c.cancelicon[1]?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+c.cancelicon[2]+"'></span>");a("#dData","#"+m+"_2").click(function(){var d=[!0,""],e,h=a("#DelData>td","#"+m).text();l={};a.isFunction(b[f.p.id].onclickSubmit)&&(l=b[f.p.id].onclickSubmit.call(f,b[f.p.id],h)||{});a.isFunction(b[f.p.id].beforeSubmit)&&
(d=b[f.p.id].beforeSubmit.call(f,h));if(d[0]&&!b[f.p.id].processing){b[f.p.id].processing=!0;n=f.p.prmNames;r=a.extend({},b[f.p.id].delData,l);t=n.oper;r[t]=n.deloper;q=n.id;h=String(h).split(",");if(!h.length)return!1;for(e in h)h.hasOwnProperty(e)&&(h[e]=a.jgrid.stripPref(f.p.idPrefix,h[e]));r[q]=h.join();a(this).addClass("ui-state-active");e=a.extend({url:b[f.p.id].url||a(f).jqGrid("getGridParam","editurl"),type:b[f.p.id].mtype,data:a.isFunction(b[f.p.id].serializeDelData)?b[f.p.id].serializeDelData.call(f,
r):r,complete:function(e,g){var l;a("#dData","#"+m+"_2").removeClass("ui-state-active");300<=e.status&&304!==e.status?(d[0]=!1,a.isFunction(b[f.p.id].errorTextFormat)?d[1]=b[f.p.id].errorTextFormat.call(f,e):d[1]=g+" Status: '"+e.statusText+"'. Error code: "+e.status):a.isFunction(b[f.p.id].afterSubmit)&&(d=b[f.p.id].afterSubmit.call(f,e,r));if(!1===d[0])a("#DelError>td","#"+m).html(d[1]),a("#DelError","#"+m).show();else{if(b[f.p.id].reloadAfterSubmit&&"local"!==f.p.datatype)a(f).trigger("reloadGrid");
else{if(!0===f.p.treeGrid)try{a(f).jqGrid("delTreeNode",f.p.idPrefix+h[0])}catch(n){}else for(l=0;l<h.length;l++)a(f).jqGrid("delRowData",f.p.idPrefix+h[l]);f.p.selrow=null;f.p.selarrrow=[]}a.isFunction(b[f.p.id].afterComplete)&&setTimeout(function(){b[f.p.id].afterComplete.call(f,e,h)},500)}b[f.p.id].processing=!1;d[0]&&a.jgrid.hideModal("#"+a.jgrid.jqID(x.themodal),{gb:"#gbox_"+a.jgrid.jqID(k),jqm:c.jqModal,onClose:b[f.p.id].onClose})}},a.jgrid.ajaxOptions,b[f.p.id].ajaxDelOptions);e.url||b[f.p.id].useDataProxy||
...
"11px";a("body").append("<div id='testpg2' class='ui-jqgrid ui-widget ui-widget-content' style='font-size:"+m+";visibility:hidden;' ></div>");m=a(u).clone().appendTo("#testpg2").width();a("#testpg2").remove();a(x+"_"+c.position,x).append(u);p.p._nvtd&&(m>p.p._nvtd[0]&&(a(x+"_"+c.position,x).width(m),p.p._nvtd[0]=m),p.p._nvtd[1]=m);u=m=m=null;this.nav=!0}}}})},navButtonAdd:function(b,c){c=a.extend({caption:"newButton",title:"",buttonicon:"ui-icon-newwin",onClickButton:null,position:"last",cursor:"pointer"},
...
extraparam:{},aftersavefunc:null,errorfunc:null,afterrestorefunc:null,restoreAfterError:!0,mtype:"POST",focusField:!0},a.jgrid.inlineEdit,p);return this.each(function(){var c=this,d,e,f,h=0,g=null,k={},l,m;c.grid&&(l=a(c).jqGrid("getInd",b,!0),!1!==l&&(f=a.isFunction(p.beforeEditRow)?p.beforeEditRow.call(c,p,b):void 0,void 0===f&&(f=!0),f&&(f=a(l).attr("editable")||"0","0"!==f||a(l).hasClass("not-editable-row")||(m=c.p.colModel,a('td[role="gridcell"]',l).each(function(f){d=m[f].name;var l=!0===c.p.treeGrid&&
d===c.p.ExpandColumn;if(l)e=a("span:first",this).html();else try{e=a.unformat.call(c,this,{rowId:b,colModel:m[f]},f)}catch(p){e=m[f].edittype&&"textarea"===m[f].edittype?a(this).text():a(this).html()}if("cb"!==d&&"subgrid"!==d&&"rn"!==d&&(c.p.autoencode&&(e=a.jgrid.htmlDecode(e)),k[d]=e,!0===m[f].editable)){null===g&&(g=f);l?a("span:first",this).html(""):a(this).html("");var t=a.extend({},m[f].editoptions||{},{id:b+"_"+d,name:d,rowId:b});m[f].edittype||(m[f].edittype="text");if("&nbsp;"===e||"&#160;"===
e||1===e.length&&160===e.charCodeAt(0))e="";var w=a.jgrid.createEl.call(c,m[f].edittype,t,e,!0,a.extend({},a.jgrid.ajaxOptions,c.p.ajaxSelectOptions||{}));a(w).addClass("editable");l?a("span:first",this).append(w):a(this).append(w);a.jgrid.bindEv.call(c,w,t);"select"===m[f].edittype&&void 0!==m[f].editoptions&&!0===m[f].editoptions.multiple&&void 0===m[f].editoptions.dataUrl&&a.jgrid.msie&&a(w).width(a(w).width());h++}}),0<h&&(k.id=b,c.p.savedRow.push(k),a(l).attr("editable","1"),p.focusField&&("number"===
typeof p.focusField&&parseInt(p.focusField,10)<=m.length&&(g=p.focusField),setTimeout(function(){var b=a("td:eq("+g+") :input:visible",l).not(":disabled");0<b.length&&b.focus()},0)),!0===p.keys&&a(l).bind("keydown",function(d){if(27===d.keyCode){a(c).jqGrid("restoreRow",b,p.afterrestorefunc);if(c.p._inlinenav)try{a(c).jqGrid("showAddEditButtons")}catch(e){}return!1}if(13===d.keyCode){if("TEXTAREA"===d.target.tagName)return!0;if(a(c).jqGrid("saveRow",b,p)&&c.p._inlinenav)try{a(c).jqGrid("showAddEditButtons")}catch(f){}return!1}}),
...
afterrestorefunc:null,restoreAfterError:!0,mtype:"POST",saveui:"enable",savetext:a.jgrid.defaults.savetext||"Saving..."},a.jgrid.inlineEdit,l),p=!1,m=this[0],r,q={},n={},t={},u,x,s;if(!m.grid)return p;s=a(m).jqGrid("getInd",b,!0);if(!1===s)return p;k=a.isFunction(l.beforeSaveRow)?l.beforeSaveRow.call(m,l,b):void 0;void 0===k&&(k=!0);if(k){k=a(s).attr("editable");l.url=l.url||m.p.editurl;if("1"===k){var w;a('td[role="gridcell"]',s).each(function(b){w=m.p.colModel[b];r=w.name;if("cb"!==r&&"subgrid"!==
r&&!0===w.editable&&"rn"!==r&&!a(this).hasClass("not-editable-cell")){switch(w.edittype){case "checkbox":var c=["Yes","No"];w.editoptions&&(c=w.editoptions.value.split(":"));q[r]=a("input",this).is(":checked")?c[0]:c[1];break;case "text":case "password":case "textarea":case "button":q[r]=a("input, textarea",this).val();break;case "select":if(w.editoptions.multiple){var c=a("select",this),d=[];q[r]=a(c).val();q[r]=q[r]?q[r].join(","):"";a("select option:selected",this).each(function(b,c){d[b]=a(c).text()});
n[r]=d.join(",")}else q[r]=a("select option:selected",this).val(),n[r]=a("select option:selected",this).text();w.formatter&&"select"===w.formatter&&(n={});break;case "custom":try{if(w.editoptions&&a.isFunction(w.editoptions.custom_value)){if(q[r]=w.editoptions.custom_value.call(m,a(".customelement",this),"get"),void 0===q[r])throw"e2";}else throw"e1";}catch(e){"e1"===e&&a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_value' "+a.jgrid.edit.msg.nodefined,a.jgrid.edit.bClose),"e2"===e?a.jgrid.info_dialog(a.jgrid.errors.errcap,
"function 'custom_value' "+a.jgrid.edit.msg.novalue,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,e.message,a.jgrid.edit.bClose)}}x=a.jgrid.checkValues.call(m,q[r],b);if(!1===x[0])return!1;m.p.autoencode&&(q[r]=a.jgrid.htmlEncode(q[r]));"clientArray"!==l.url&&w.editoptions&&!0===w.editoptions.NullIfEmpty&&""===q[r]&&(t[r]="null")}});if(!1===x[0]){try{var B=a(m).jqGrid("getGridRowById",b),v=a.jgrid.findPos(B);a.jgrid.info_dialog(a.jgrid.errors.errcap,x[1],a.jgrid.edit.bClose,{left:v[0],
top:v[1]+a(B).outerHeight()})}catch(H){alert(x[1])}return p}k=m.p.prmNames;B=b;v=!1===m.p.keyName?k.id:m.p.keyName;q&&(q[k.oper]=k.editoper,void 0===q[v]||""===q[v]?q[v]=b:s.id!==m.p.idPrefix+q[v]&&(k=a.jgrid.stripPref(m.p.idPrefix,b),void 0!==m.p._index[k]&&(m.p._index[q[v]]=m.p._index[k],delete m.p._index[k]),b=m.p.idPrefix+q[v],a(s).attr("id",b),m.p.selrow===B&&(m.p.selrow=b),a.isArray(m.p.selarrrow)&&(k=a.inArray(B,m.p.selarrrow),0<=k&&(m.p.selarrrow[k]=b)),m.p.multiselect&&(k="jqg_"+m.p.id+"_"+
...
this;if(c.grid){var f=function(b,d,e){d=a("<td align='"+c.p.subGridModel[0].align[e]+"'></td>").html(d);a(b).append(d)},g=function(b,d){var e,h,g,k=a("<table cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),l=a("<tr></tr>");for(h=0;h<c.p.subGridModel[0].name.length;h++)e=a("<th class='ui-state-default ui-th-subgrid ui-th-column ui-th-"+c.p.direction+"'></th>"),a(e).html(c.p.subGridModel[0].name[h]),a(e).width(c.p.subGridModel[0].width[h]),a(l).append(e);a(k).append(l);b&&(g=c.p.xmlReader.subgrid,
a(g.root+" "+g.row,b).each(function(){l=a("<tr class='ui-widget-content ui-subtblcell'></tr>");if(!0===g.repeatitems)a(g.cell,this).each(function(b){f(l,a(this).text()||"&#160;",b)});else{var b=c.p.subGridModel[0].mapping||c.p.subGridModel[0].name;if(b)for(h=0;h<b.length;h++)f(l,a(b[h],this).text()||"&#160;",h)}a(k).append(l)}));e=a("table:first",c.grid.bDiv).attr("id")+"_";a("#"+a.jgrid.jqID(e+d)).append(k);c.grid.hDiv.loading=!1;a("#load_"+a.jgrid.jqID(c.p.id)).hide();return!1},d=function(b,d){var e,
h,g,k,l,n=a("<table cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),p=a("<tr></tr>");for(h=0;h<c.p.subGridModel[0].name.length;h++)e=a("<th class='ui-state-default ui-th-subgrid ui-th-column ui-th-"+c.p.direction+"'></th>"),a(e).html(c.p.subGridModel[0].name[h]),a(e).width(c.p.subGridModel[0].width[h]),a(p).append(e);a(n).append(p);if(b&&(k=c.p.jsonReader.subgrid,e=a.jgrid.getAccessor(b,k.root),void 0!==e))for(h=0;h<e.length;h++){g=e[h];p=a("<tr class='ui-widget-content ui-subtblcell'></tr>");
if(!0===k.repeatitems)for(k.cell&&(g=g[k.cell]),l=0;l<g.length;l++)f(p,g[l]||"&#160;",l);else{var m=c.p.subGridModel[0].mapping||c.p.subGridModel[0].name;if(m.length)for(l=0;l<m.length;l++)f(p,g[m[l]]||"&#160;",l)}a(n).append(p)}h=a("table:first",c.grid.bDiv).attr("id")+"_";a("#"+a.jgrid.jqID(h+d)).append(n);c.grid.hDiv.loading=!1;a("#load_"+a.jgrid.jqID(c.p.id)).hide();return!1},h=function(b){var e,f,h,k;e=a(b).attr("id");f={nd_:(new Date).getTime()};f[c.p.prmNames.subgridid]=e;if(!c.p.subGridModel[0])return!1;
...
2:k[v][m]);c[p]=h;c[m]=h+1}else{h=parseInt(a(g).jqGrid("getCol",m,!1,"max"),10);k=a.jgrid.from(g.p.data).greater(p,h,{stype:"integer"}).select();if(k.length)for(v in k)k.hasOwnProperty(v)&&(k[v][p]=parseInt(k[v][p],10)+2);k=a.jgrid.from(g.p.data).greater(m,h,{stype:"integer"}).select();if(k.length)for(v in k)k.hasOwnProperty(v)&&(k[v][m]=parseInt(k[v][m],10)+2);c[p]=h+1;c[m]=h+2}}if(null===e||a(g).jqGrid("isNodeLoaded",t)||w)a(g).jqGrid("addRowData",b,c,q,s),a(g).jqGrid("setTreeNode",x,n);t&&!t[d]&&
...
e-b){d=c[a];break}}return d}function d(b,c,d,f){var k=g(b,c,d),l=h.p.colModel,n,p=k.cnt;b="";var m;for(m=f;m<e;m++){var q="<td "+h.formatCol(m,1,"")+">&#160;</td>",r="{0}";a.each(k.summary,function(){if(this.nm===l[m].name){l[m].summaryTpl&&(r=l[m].summaryTpl);"string"===typeof this.st&&"avg"===this.st.toLowerCase()&&(this.sd&&this.vd?this.v/=this.vd:this.v&&0<p&&(this.v/=p));try{this.groupCount=k.cnt,this.groupIndex=k.dataIndex,this.groupValue=k.value,n=h.formatter("",this.v,m,this)}catch(b){n=this.v}q=
"<td "+h.formatCol(m,1,"")+">"+a.jgrid.format(r,n)+"</td>";return!1}});b+=q}return b}var h=this,k=h.p.groupingView,l="",p="",m,r,q=k.groupCollapse?k.plusicon:k.minusicon,n,t=[],u=k.groupField.length,q=q+(" tree-wrap-"+h.p.direction);a.each(h.p.colModel,function(a,b){var c;for(c=0;c<u;c++)if(k.groupField[c]===b.name){t[c]=a;break}});var x=0,s=a.makeArray(k.groupSummary),w;s.reverse();w=h.p.multiselect?' colspan="2"':"";a.each(k.groups,function(g,v){if(k._locgr&&!(v.startRow+v.cnt>(c-1)*f&&v.startRow<
...
(l+='<tr id="'+m+'"'+(k.groupCollapse&&0<v.idx?' style="display:none;" ':" ")+'role="row" class= "ui-widget-content jqgroup ui-row-'+h.p.direction+" "+r+'"><td style="padding-left:'+12*v.idx+'px;"'+w+">"+p+a.jgrid.template(k.groupText[v.idx],n,v.cnt,v.summary)+"</td>",l+=d(g,0,k.groups,!1===k.groupColumnShow[v.idx]?""===w?2:3:""===w?1:2),l+="</tr>"):l+='<tr id="'+m+'"'+(k.groupCollapse&&0<v.idx?' style="display:none;" ':" ")+'role="row" class= "ui-widget-content jqgroup ui-row-'+h.p.direction+" "+
r+'"><td style="padding-left:'+12*v.idx+'px;" colspan="'+(!1===k.groupColumnShow[v.idx]?e-1:e)+'">'+p+a.jgrid.template(k.groupText[v.idx],n,v.cnt,v.summary)+"</td></tr>";if(u-1===v.idx){var A=k.groups[g+1],D,C=0;D=v.startRow;var F=void 0!==A?A.startRow:k.groups[g].startRow+k.groups[g].cnt;k._locgr&&(C=(c-1)*f,C>v.startRow&&(D=C));for(;D<F&&b[D-C];D++)l+=b[D-C].join("");if("header"!==k.groupSummaryPos[v.idx]){var y;if(void 0!==A){for(y=0;y<k.groupField.length&&A.dataIndex!==k.groupField[y];y++);x=
k.groupField.length-y}for(A=0;A<x;A++)s[A]&&(C="",k.groupCollapse&&!k.showSummaryOnHide&&(C=' style="display:none;"'),l+="<tr"+C+' jqfootlevel="'+(v.idx-A)+'" role="row" class="ui-widget-content jqfoot ui-row-'+h.p.direction+'">',l+=d(g,A,k.groups,0),l+="</tr>");x=y}}});a("#"+a.jgrid.jqID(h.p.id)+" tbody:first").append(l);l=null})},groupingGroupBy:function(b,e){return this.each(function(){"string"===typeof b&&(b=[b]);var c=this.p.groupingView;this.p.grouping=!0;c._locgr=!1;void 0===c.visibiltyOnNextGrouping&&
...
1,1)}null!=a[d]&&"object"===typeof a[d]&&t(a[d]);if("level"===d&&0<a.level)for(b in c=0,a.fields)if(a.fields.hasOwnProperty(b)){g={};for(e in m.aggregates[c])if(m.aggregates[c].hasOwnProperty(e))switch(e){case "member":case "label":case "aggregator":break;default:g[e]=m.aggregates[c][e]}1<H?(g.name=b,g.label=m.aggregates[c].label||a.label):(g.name=a.text,g.label="_r_Totals"===a.text?m.rowTotalsText:a.label);f.push(g);c++}}}var u,x,s,w=e.length,B,v,H,A,D=0;m.rowTotals&&0<m.yDimension.length&&(m.yDimension.splice(0,
0,{dataName:m.yDimension[0].dataName}),m.yDimension[0].converter=function(){return"_r_Totals"});B=a.isArray(m.xDimension)?m.xDimension.length:0;v=m.yDimension.length;H=a.isArray(m.aggregates)?m.aggregates.length:0;if(0===B||0===H)throw"xDimension or aggregates optiona are not set!";var C;for(s=0;s<B;s++)C={name:m.xDimension[s].dataName,frozen:m.frozenStaticCols},null==m.xDimension[s].isGroupField&&(m.xDimension[s].isGroupField=!0),C=a.extend(!0,C,m.xDimension[s]),f.push(C);C=B-1;for(var F={};D<w;){u=
e[D];var y=[],M=[];A={};s=0;do y[s]=a.trim(u[m.xDimension[s].dataName]),A[m.xDimension[s].dataName]=y[s],s++;while(s<B);var z=0;x=-1;s=c(g,q,y);if(!s){z=0;if(1<=v){for(z=0;z<v;z++)M[z]=a.trim(u[m.yDimension[z].dataName]),m.yDimension[z].converter&&a.isFunction(m.yDimension[z].converter)&&(M[z]=m.yDimension[z].converter.call(this,M[z],y,M));A=n(u,m.aggregates,M,A)}else 0===v&&(A=n(u,m.aggregates,null,A));g.push(A)}else if(0<=x){z=0;if(1<=v){for(z=0;z<v;z++)M[z]=a.trim(u[m.yDimension[z].dataName]),
m.yDimension[z].converter&&a.isFunction(m.yDimension[z].converter)&&(M[z]=m.yDimension[z].converter.call(this,M[z],y,M));s=n(u,m.aggregates,M,s)}else 0===v&&(s=n(u,m.aggregates,null,s));g[x]=s}u=0;var y=A=null,L;for(L in h)if(h.hasOwnProperty(L)){if(0===u)F.children&&void 0!==F.children||(F={text:L,level:0,children:[],label:L}),A=F.children;else{y=null;for(s=0;s<A.length;s++)if(A[s].text===L){y=A[s];break}y?A=y.children:(A.push({children:[],text:L,level:u,fields:h[L],label:k[L]}),A=A[A.length-1].children)}u++}D++}var P=
[],U=f.length,X=U;0<v&&(p[v-1]={useColSpanStyle:!1,groupHeaders:[]});t(F);if(m.colTotals)for(D=g.length;D--;)for(s=B;s<f.length;s++)w=f[s].name,d[w]=d[w]?d[w]+parseFloat(g[D][w]||0):parseFloat(g[D][w]||0);if(0<C)for(s=0;s<C;s++)f[s].isGroupField&&(l.groupingView.groupField.push(f[s].name),l.groupingView.groupSummary.push(m.groupSummary),l.groupingView.groupSummaryPos.push(m.groupSummaryPos));else l.grouping=!1;l.sortname=f[C].name;l.groupingView.hideFirstGroupCol=!0});return{colModel:f,rows:g,groupOptions:l,
